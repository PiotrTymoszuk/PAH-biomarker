...
paper_tables$cohort_features %>% 
  ...
  footnote(c(2, 8:10), 4, part = 'body', value = as_paragraph('Mann-Whitney U test.', ref_symbols = '1')) %>% 
  footnote(c(2, 8:10), 5, part = 'body', value = as_paragraph('Wilcoxon r effect size statistic.'), ref_symbols = '2') %>% 
  footnote(c(3:7, 11), 4, part = 'body', value = as_paragraph('\u03C7\u00B2 test.'), ref_symbols = '3') %>% 
  footnote(c(3:7, 11), 5, part = 'body', value = as_paragraph('Cramer V effect size statistic.'), ref_symbols = '4') %>% 
  footnote(12, 4, part = 'body', value = as_paragraph('Mentel-Haenszel test'), ref_symbols = '5') %>% 
...
```{r fig-strobe, fig.width = mm_inch(paper_figures$strobe$w), fig.height = mm_inch(paper_figures$strobe$h), fig.cap = 'CONSORT flow diagram of the study analysis inclusion process.'}
