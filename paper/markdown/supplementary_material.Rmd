...
suppl_tables$cohort_features %>% 
  ...
  footnote(c(2, 4:15), 4, part = 'body', value = as_paragraph('Mann-Whitney U test.', ref_symbols = '1')) %>% 
  footnote(c(2, 4:15), 5, part = 'body', value = as_paragraph('Wilcoxon r effect size statistic.', ref_symbols = '2')) %>% 
  footnote(c(3, 16, 17), 4, part = 'body', value = as_paragraph('\u03C7\u00B2 test.'), ref_symbols = '3') %>% 
  footnote(c(3, 16, 17), 5, part = 'body', value = as_paragraph('Cramer V effect size statistic.'), ref_symbols = '4') %>% 
  font(part = 'all', fontname = 'Cambria') %>% 
  fontsize(size = 10, part = 'all') %>% 
  theme_vanilla
...
suppl_tables$clust_IBK %>% 
  ...
  width(4, width = 2.5, unit = 'cm') %>% 
  width(5, width = 2, unit = 'cm') %>% 
  footnote(c(2:3, 5:6, 8, 10:13, 15:17, 19, 22:26), 4, part = 'body', value = as_paragraph('Mann-Whitney U test.', ref_symbols = '1')) %>% 
  footnote(c(2:3, 5:6, 8, 10:13, 15:17, 19, 22:26), 5, part = 'body', value = as_paragraph('Wilcoxon r effect size statistic.', ref_symbols = '2')) %>% 
  footnote(c(4, 7, 9, 14, 18, 20:21), 4, part = 'body', value = as_paragraph('\u03C7\u00B2 test.'), ref_symbols = '3') %>% 
  footnote(c(4, 7, 9, 14, 18, 20:21), 5, part = 'body', value = as_paragraph('Cramer V effect size statistic.'), ref_symbols = '4') %>% 
  font(part = 'all', fontname = 'Cambria') %>% 
  fontsize(size = 10, part = 'all') %>% 
  theme_vanilla
...
```{r fig-clust-diff, fig.width = mm_inch(suppl_figures$clust_diff$w), fig.height = mm_inch(suppl_figures$clust_diff$h), fig.cap = 'Differences in study variable between the participant clusters.'}
